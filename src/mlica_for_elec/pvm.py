...
def pvm(value_model, scaler, caps, L, parameters, epochs, batch_size, model_name, sample_weight_on, sample_weight_scaling, min_iteration, seed_instance, regularization_type, Mip_bounds_tightening, warm_start):
    start0 = time.time()
    if not scaler:
        scaler = None
    c0 = caps[0]
